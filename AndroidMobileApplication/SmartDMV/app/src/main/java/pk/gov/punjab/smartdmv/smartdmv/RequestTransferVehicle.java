...
public class RequestTransferVehicle extends AsyncTask<String,Void,String> {
    ...
    public RequestTransferVehicle(Context context) {
    ...
    protected String doInBackground(String... arg0) {
        ...
        try {
            ...
            Request request = new Request.Builder()
                    .url("http://"+DashboardActivity.IPAddress+":10000/api/banks/" + arg0[2])
                    .build();
        ...
        if(verifyPayment.equals("true"))
        {
            try {
                ...
                String data = "{\"$class\": \"org.smart.dmv.TransferOwnershipTransaction\"," +
                        "\"asset\": \"org.smart.dmv.Vehicle#" +arg0[0]+"\"," +
                        "\"newOwner\": \"org.smart.dmv.Owner#"+arg0[1]+"\"}";

                MediaType JSON = MediaType.get("application/json; charset=utf-8");
                RequestBody body = RequestBody.create(JSON, data);
                Request request = new Request.Builder()
                        .url("http://"+DashboardActivity.IPAddress+":3001/api/TransferOwnershipTransaction")
                        .post(body)
    ...
    protected void onPostExecute(String s) {
        ...
        {
            Toast.makeText(context , "Transferred Successfully" , Toast.LENGTH_LONG).show();
        }
