...
public class RequestSubmitTokenTax extends AsyncTask<String,Void,String> {
    ...
    public RequestSubmitTokenTax(Context context) {
    ...
    protected String doInBackground(String... arg0) {
        ...
        if(verifyPayment.equals("true"))
        {
            try {
                ...
                String data = "{\"$class\": \"org.smart.dmv.SubmitTokenTaxTransaction\"," +
                        "\"asset\": \"org.smart.dmv.Vehicle#"+arg0[0]+"\"}";

                MediaType JSON = MediaType.get("application/json; charset=utf-8");
                RequestBody body = RequestBody.create(JSON, data);
                Request request = new Request.Builder()
                        .url("http://"+DashboardActivity.IPAddress+":3001/api/SubmitTokenTaxTransaction")
                        .post(body)
    ...
    protected void onPostExecute(String s) {
        ...
        {
            Toast.makeText(context , "Submitted TokenTax Successfully" , Toast.LENGTH_LONG).show();
        }
